    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Location Add & Show</h6>
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    ...
                                    <input class="form-control" type="text" name="name"  v-model="form.name" placeholder="Enter Location Name">
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Location List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                        <tr v-for="(data, index) in location">
                            <td>{{ index+1 }}</td>
                            <td>{{ data.name }}</td>
                            <td>{{ data.status==1? "Active":"Inactive" }}</td>
                            <td>
                                <Link class="btn btn-success" :href="route('admin.location.edit',data.id)" style="text-align: end; color:white; margin-right: 2px;" >Edit</Link>
...
export default {
    ...
    methods:{
        // submit(){
        //     this.form.post(route('admin.location.store'))
        //     this.form.reset();
        // },
        submit(){
            if(this.form.isDirty==true)
            {
                ...
                Swal.fire(
                    'Success!',
                    'You location Data Submit Successfully!',
                    'success'
                )
            }
            else {
        ...
        //         this.$inertia.delete('location-delete/'+id);
        //     }
        // },
        destroy: function (id) {
            Swal.fire({
