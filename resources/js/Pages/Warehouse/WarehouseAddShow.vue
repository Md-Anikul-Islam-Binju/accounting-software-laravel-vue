    ...
    <div class="sl-mainpanel">
        ...
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Warehouse Add & Show</h6>
                <form @submit.prevent="submit">
                    <div class="form-layout">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group mg-b-10-force">
                                    <label class="form-control-label">Warehouse Title: <span class="tx-danger">*</span></label>
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Warehouse List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-15p">Warehouse Title</th>
                        ...
                        <tbody>
                        <tr v-for="(data, index) in warehouses">
                            <td>{{ index+1 }}</td>
                            <td>{{ data.name }}</td>
                            <td>{{ data.title }}</td>
                            <td>{{ data.address }}</td>
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.warehouse.edit',data.id)" style="text-align: end; color:white; margin-right: 2px;" >Edit</Link>
...
export default {
    ...
    methods:{
        // submit(){
        //     this.form.post(route('admin.warehouse.store'))
        //     this.form.reset();
        // },
        submit(){
            if(this.form.isDirty==true)
            {
                ...
                Swal.fire(
                    'Success!',
                    'You Warehouse Data Submit Successfully!',
                    'success'
                )
            }
            else {
        ...
        //         this.$inertia.delete('warehouse-delete/'+id);
        //     }
        // },
        destroy: function (id) {
            Swal.fire({
