...
<AdminIndex />
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Sale List</a>
        </nav>


        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Sale List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr v-for="(data, index) in sale">
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.sale.edit',data.id)" style="text-align: end; color:white;" >Edit</Link>
        ...
        destroy: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete('sale-delete/'+id);
                    Swal.fire(
                        'Deleted!',
