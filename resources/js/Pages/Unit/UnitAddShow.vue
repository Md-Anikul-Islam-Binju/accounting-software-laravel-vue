...
<AdminIndex />
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Unit</a>
        </nav>
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Unit Add & Show</h6>
                <form @submit.prevent="submit">
                <div class="form-layout">
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                <label class="form-control-label">Unit Name: <span class="tx-danger">*</span></label>
                                <input class="form-control" type="text" name="name" v-model="form.name"  placeholder="Enter Unit Name">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2" v-model="form.type"  data-placeholder="Choose Type">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Unit List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr v-for="(data, index) in units">
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.unit.edit',data.id)" style="text-align: end; color:white; margin-right: 2px;" >Edit</Link>
...
export default {
    ...
    methods:{
        ...
        //         this.$inertia.delete('unit-delete/'+id);
        //     }
        // },
        destroy: function (id) {
            Swal.fire({
