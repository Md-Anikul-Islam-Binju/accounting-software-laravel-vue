...
<AdminIndex />
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Service List</a>
        </nav>
            ...
            <div class="card pd-20 pd-sm-40">
                ...
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                        <tr v-for="(data, index) in service">
                            <td>{{ index+1 }}</td>
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.service.edit',data.id)" style="text-align: end; color:white;" >Edit</Link>
        ...
        destroy: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete('service-delete/'+id);
                    Swal.fire(
                        'Deleted!',
