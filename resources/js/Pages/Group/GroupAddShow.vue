<template>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Group</a>
        </nav>
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Group Add & Show</h6>
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="form-group mg-b-10-force">
                                ...
                                <input class="form-control" type="text" name="name" v-model="form.name" placeholder="Enter Group Name">
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="form-group mg-b-10-force">
        ...
        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Group List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tr v-for="(data, index) in groups">
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.group.edit',data.id)" style="text-align: end; color:white; margin-right: 2px;" >Edit</Link>
...
export default {
    ...
    methods:{
        // submit(){
        //     this.form.post(route('admin.group.store'))
        //     this.form.reset();
        // },
        submit(){
            if(this.form.isDirty==true)
            {
                ...
                Swal.fire(
                    'Success!',
                    'You Group Data Submit Successfully!',
                    'success'
                )
            }
            else {
        ...
        //         this.$inertia.delete('group-delete/'+id);
        //     }
        // },
        destroy: function (id) {
            Swal.fire({
