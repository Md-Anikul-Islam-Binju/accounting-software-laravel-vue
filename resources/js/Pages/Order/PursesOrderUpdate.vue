<template>
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Purses Order</a>
        </nav>
        <div class="sl-pagebody">
            ...
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Purses Order Update</h6>
...
export default {
    ...
    data(){
        return{
            form:this.$inertia.form({
                item_id:this.pursesOrder.item_id,
                supplier_type:this.pursesOrder.supplier_type,
                supplier_name:this.pursesOrder.supplier_name,
                phone:this.pursesOrder.phone,
                address:this.pursesOrder.address,
                details:this.pursesOrder.details,
                qty:this.pursesOrder.qty,
                rate:this.pursesOrder.rate,
                date:this.pursesOrder.date,
                total:this.pursesOrder.total,
                discount:this.pursesOrder.discount,
                vat:this.pursesOrder.vat,
                order_number:this.pursesOrder.order_number,
                sub_total:this.pursesOrder.sub_total,
                transport_cost:this.pursesOrder.transport_cost,
                grand_total:this.pursesOrder.grand_total,
                institution:this.pursesOrder.institution,
            })
        }
    },
    ...
    methods:{
        update(){
            this.form.post(route('admin.purses.order.update',this.pursesOrder.id))
            this.form.reset();
        }
    },
}
