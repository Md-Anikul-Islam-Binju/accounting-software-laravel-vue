...
<AdminIndex />
    ...
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Purses Order List</a>
        </nav>


        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Purses Order List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                        <tr v-for="(data, index) in pursesOrder">
                            <td>{{ index+1 }}</td>
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.purses.order.edit',data.id)" style="text-align: end; color:white;" >Edit</Link>
        ...
        destroy: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete('purses-order-delete/'+id);
                    Swal.fire(
                        'Deleted!',
                        'Your purses order has been deleted.',
                        'success'
                    )
                }
            })
