...
<AdminIndex />
    <div class="sl-mainpanel">
        <nav class="breadcrumb sl-breadcrumb">
            ...
            <a class="breadcrumb-item" href="#">Sale Order List</a>
        </nav>


        <div class="sl-pagebody">
            <div class="card pd-20 pd-sm-40">
                <h6 class="card-body-title">Sale Order List</h6>
                <div class="table-wrapper">
                    <table id="datatable1" class="table display responsive nowrap">
                        ...
                        <tbody>
                        <tr v-for="(data, index) in saleOrder">
                            <td>{{ index+1 }}</td>
                            ...
                            <td>
                                <Link class="btn btn-success" :href="route('admin.sale.order.edit',data.id)" style="text-align: end; color:white;" >Edit</Link>
        ...
        destroy: function (id) {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    this.$inertia.delete('sale-order-delete/'+id);
                    Swal.fire(
                        'Deleted!',
                        'Your sale order has been deleted.',
                        'success'
                    )
                }
            })
